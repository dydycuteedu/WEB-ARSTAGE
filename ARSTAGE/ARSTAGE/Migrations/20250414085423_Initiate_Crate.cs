...
{
    /// <inheritdoc />
    public partial class Initiate_Crate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocalMediaLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artists_AspNetUsers_ArtistId",
                        column: x => x.ArtistId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Samplelink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SendDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistConfirmations", x => x.ConfirmationID);
                    table.ForeignKey(
                        name: "FK_ArtistConfirmations_Artists_ArtistID",
                        column: x => x.ArtistID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommissionModel", x => x.CommissionID);
                    table.ForeignKey(
                        name: "FK_CommissionModel_Artists_ArtistID",
                        column: x => x.ArtistID,
                        principalTable: "Artists",
                        principalColumn: "ArtistId");
                    table.ForeignKey(
                        name: "FK_CommissionModel_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Follows_Artists_FollowingID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reviews_CommissionModel_CommissionID",
                        column: x => x.CommissionID,
                        principalTable: "CommissionModel",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_CommissionModel_CommissionID",
                        column: x => x.CommissionID,
                        principalTable: "CommissionModel",
                        principalColumn: "CommissionID");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1832f896-59e1-43ac-a0f2-7beedc37f24b", "Admin", "ADMIN" },
                    { "2", "0b6565f6-f933-4528-a95f-bfce964f2a6a", "Member", "MEMBER" },
                    { "3", "6b268b21-bcc2-4fbf-81b7-5067842e65fa", "Artist", "ARTIST" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ArtistConfirmations_ArtistID",
                table: "ArtistConfirmations",
                column: "ArtistID",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionModel_ArtistID",
                table: "CommissionModel",
                column: "ArtistID");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionModel_UserID",
                table: "CommissionModel",
                column: "UserID");
